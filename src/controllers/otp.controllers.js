...
const registerOTP = asyncHandler(async (req, res) => {
  ...
  sendMail({
    email,
    subject: `${otp} is your Sanga Verification Code`,
    content: `
    <!DOCTYPE html>
    <html>
    <head>
        <title>Your Sanga Verification Code</title>
    </head>
    <body>
        <p>Thank you for choosing Sanga! Your One-Time Password (OTP) for verification is:</p>
        ...
        <p>Best regards,<br/>The Sanga Team</p>
    </body>
    </html>
    `,
  });
